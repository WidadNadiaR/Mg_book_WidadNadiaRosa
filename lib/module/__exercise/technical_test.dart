...
class TechnicalTest {
  ...
  },
  {
    ...
    () {
      ...
      String? output;
      output = "${input.year}-${input.month < 10 ? '0' + input.month.toString() : input.month}-${input.day < 10 ? '0' + input.day.toString() : input.day}";
    ...
    () {
      ...
      String input = "false";
       bool? output;
       output = input.toLowerCase() == 'false' ? false : null;
      // --- End of Answer ---
      return output is bool && output == false;
    },
    // Exercise 113
  ...
  output = input;
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
       ...
       List<DateTime>? output = input.split(",").map(DateTime.parse).toList();
